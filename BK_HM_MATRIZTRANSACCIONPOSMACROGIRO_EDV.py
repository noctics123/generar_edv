...
dbutils.widgets.text(name="PRM_TABLE_NAME", defaultValue='HM_MATRIZTRANSACCIONPOSMACROGIRO_RUBEN_2')
...
dbutils.widgets.text(name="PRM_TABLA_SEGUNDATRANSPUESTA_TMP", defaultValue='hm_matriztransaccionposmacrogiro_tmp_ruben_2')
