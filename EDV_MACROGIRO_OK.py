...
dbutils.widgets.text(name="PRM_FECHA_RUTINA", defaultValue='2025-08-02')
...
# OPTIMIZACIÓN FASE 1: Configuración de Spark para mejor rendimiento
...
def agruparInformacionMesAnalisis(dfInfo12Meses):
    ...
    # OPTIMIZACIÓN FASE 1: Materializar explícitamente el DF antes de usarlo
...
def logicaPostAgrupacionInformacionMesAnalisis(dfMatrizVarTransaccionPosMacrogiro): 
    ...
    # OPTIMIZACIÓN FASE 1: Repartition antes de escribir para optimizar shuffle de escritura
    # Esto balancea las particiones según la columna de particionamiento físico
