...
# || 1.6      RUBEN QUISPE                    NTT DATA      RODRIGO ROJAS       19/09/25     Ajuste de proceso
# ********************************************************************************************************************
...
dbutils.widgets.text(name="PRM_TABLE_NAME", defaultValue='HM_MATRIZTRANSACCIONCAJERO')
dbutils.widgets.text(name="PRM_CATALOG_NAME", defaultValue='catalog_lhcl_desa_bcp')
dbutils.widgets.text(name="PRM_FECHA_RUTINA", defaultValue='2024-01-15')
dbutils.widgets.text(name="PRM_TABLA_PRIMERATRANSPUESTA", defaultValue='hm_conceptotransaccioncajero')
dbutils.widgets.text(name="PRM_TABLA_SEGUNDATRANSPUESTA", defaultValue='hm_matriztransaccioncajero')
dbutils.widgets.text(name="PRM_TABLA_SEGUNDATRANSPUESTA_TMP", defaultValue='hm_matriztransaccioncajero_tmp')
...
PRM_ESQUEMA_TABLA = PRM_CATALOG_NAME+"."+PRM_ESQUEMA_TABLA_X
...
def extraccionInformacion12Meses(codMes, codMes12Atras, carpetaDetConceptoClienteSegundaTranspuesta, carpetaClientePrimeraTranspuesta):
    ...
    tmp_table = f"{PRM_ESQUEMA_TABLA}.{carpetaClientePrimeraTranspuesta}_tmp"
    ruta_salida = PRM_CARPETA_RAIZ_DE_PROYECTO+"/temp/"+carpetaClientePrimeraTranspuesta
    dfInfo12MesesStep01.write.format(funciones.CONS_FORMATO_DE_ESCRITURA_EN_DISCO).mode(funciones.CONS_MODO_DE_ESCRITURA).saveAsTable(tmp_table, path = ruta_salida)
...
def main():
    ...
    for index, row in  totalMeses.iterrows():
        ...
        tmp_table_1 = f'{PRM_ESQUEMA_TABLA}.{carpetaClientePrimeraTranspuesta}_tmp'.lower()
